  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-md border-b border-outline-variant/40 bg-ivory/70 px-window-padding glass">
      ...
      <div className="relative ml-auto w-64">
        <Search className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground" strokeWidth={2} />
        <Input
          placeholder="搜索…"
          className="h-8 border-transparent bg-surface-container-high/60 pl-9 text-body-md"
        />
      </div>
      ...
      <div className="flex items-center gap-1">
        <Button variant="ghost" size="icon" className="h-8 w-8" title="同步">
          <RefreshCw className="h-4 w-4" strokeWidth={2} />
        </Button>
        <Button variant="ghost" size="icon" className="h-8 w-8" title="通知">
